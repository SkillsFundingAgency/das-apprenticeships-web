    ...
    public static class NotFoundHandlerMiddleware
    {
        public static async Task Ensure404ResponsesRedirectToErrorPage(HttpContext context, Func<Task> next)
        {
            if (context.Response.StatusCode == 404)
            {
                ...
                {
                    // If the response has not been started then the 404 was generated by a controller returning NotFound.
                    // In this case we need to call the controller directly.
