...
[TestFixture]
public class PaymentsFreezeEmployerControllerTests
{
    private readonly Fixture _fixture;
    private readonly Mock<ILogger<PaymentsFreezeEmployerController>> _mockLogger;
    ...
    public PaymentsFreezeEmployerControllerTests()
    {
        _fixture = new Fixture();
        _mockLogger = new Mock<ILogger<PaymentsFreezeEmployerController>>();
    ...
    public async Task FreezeProviderPaymentsPage_Get_ReturnsCorrectModel()
    {
        ...
        var controller = new PaymentsFreezeEmployerController(_mockLogger.Object, _mockApprenticeshipService.Object, _mockCacheService.Object, GetUrlBuilder());
    ...
    public async Task UnfreezeProviderPaymentsPage_Post_ValidModel_FreezesPaymentsAndRedirectsBackToEmployerCommitments()
    {
        ...
        result.ShouldBeOfType<RedirectResult>();
        ((RedirectResult)result).Url.Should().Be($"https://approvals.at-eas.apprenticeships.education.gov.uk/{model.EmployerAccountId}/apprentices/{model.ApprenticeshipHashedId.ToUpper()}/details?banners={(ulong)EmployerApprenticeDetailsBanners.ProviderPaymentsActive}");
    }
