...
namespace SFA.DAS.Apprenticeships.Web.UnitTests.Validators
{
    ...
    public class CreateChangeOfPriceModelValidatorTests
    {
        ...
        [TestCase(_trainingPriceMessage, "ApprenticeshipTrainingPrice", 0, 1000, 2000, 2000)]
        [TestCase(_trainingPriceMessage, "ApprenticeshipTrainingPrice", 100001, 1000, 2000, 2000)]
        [TestCase(_endPointAssessmentPriceMessage, "ApprenticeshipEndPointAssessmentPrice", 1000, 0, 2000, 2000)]
        [TestCase(_endPointAssessmentPriceMessage, "ApprenticeshipEndPointAssessmentPrice", 1000, 100001, 2000, 2000)]
        [TestCase(_totalPriceExceedsMaximum, "ApprenticeshipTotalPrice", 95000, 15000, 2000, 2000)]
